...
import 'package:mms_app/core/utils/notification_manager.dart';
...
class AuthViewModel extends BaseModel {
  ...
  Future<void> login(Map<String, String> data) async {
    ...
    try {
      ...
      AppCache.setMyChurch(userModel.church);
      AppCache.setMyToken(userModel.token);
      setBusy(false);
  ...
  Future<void> updateToken() async {
    setBusy(true);
    String msgToken = await NotificationManager.messagingToken();
    try {
      await _authApi.updateDeviceToken(msgToken);
      setBusy(false);
    } on CustomException {
      setBusy(false);
    }
